...
class CampaignLifecycleServiceImplTest {
        ...
        @Test
        void shouldAllowExecutionForActiveCampaign() {
        ...
        @Test
        void shouldRejectExecutionForFinishedCampaign() {
        ...
        @Test
        void shouldRejectExecutionForAbandonedCampaign() {
                ...
                assertEquals(
                                "Campaign cannot be simulated because its status is ABANDONED",
                                exception.getMessage());
        }

        @Test
        void shouldRejectExecutionForNullCampaign() {
